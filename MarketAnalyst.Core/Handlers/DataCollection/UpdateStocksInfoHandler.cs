...
{
    public class UpdateStocksInfoHandler : IRequestHandler<UpdateStocksInfoCommand, GenericBoolResponse>
    {
        IUnitOfWork _unitOfWork { get; set; }
        IHttpCallService _httpCallService { get; set; }
        public UpdateStocksInfoHandler(IUnitOfWork unitOfWork, IHttpCallService httpCallService)
        {
